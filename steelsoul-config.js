...
const STEELSOUL_CONFIG = {
  ...
  // Clips pro Run: Bereich G2:H100. Zeile 1 = Überschrift "Clips", ignoriert.
  // G = Versuch-Referenz, H = Kategorie/Titel aus einer Dropdown-Liste
  // (der eigentliche Link liegt aktuell noch woanders / fehlt teils).
  clipColumns: {
    attempt: 'G',
    label:   'H',
  }
